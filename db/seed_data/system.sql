...
DO $create_systems$ DECLARE ___ INTEGER; BEGIN
    ...
    >>
        ...
        SELECT 1 FROM update_entire_system((
            ...
            ARRAY[
                ('SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.__CT__.HEAD.STOPS.UP', NULL, NULL, <<PART_ID>>),
                ('SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.__CT__.HEAD.STOPS.DOWN.GLAZING.OUTSIDE', NULL, NULL, <<PART_ID>>),
                ('SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.__CT__.HEAD.STOPS.DOWN.GLAZING.INSIDE', NULL, NULL, <<PART_ID>>),
                ('SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.__CT__.HEAD.STOPS.UP', NULL, NULL, <<OTHER_PART_ID>>),
                ('SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.__CT__.HEAD.STOPS.DOWN.GLAZING.OUTSIDE', NULL, NULL, <<OTHER_PART_ID>>),
                ('SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.__CT__.HEAD.STOPS.DOWN.GLAZING.INSIDE', NULL, NULL, <<OTHER_PART_ID>>),
                ('SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.__CT__.HEAD.STOPS.UP', NULL, NULL, <<OTHER_PART_ID>>),
                ('SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.__CT__.HEAD.STOPS.DOWN.GLAZING.OUTSIDE', NULL, NULL, <<OTHER_PART_ID>>),
                ('SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.__CT__.HEAD.STOPS.DOWN.GLAZING.INSIDE', NULL, NULL, <<OTHER_PART_ID>>)
