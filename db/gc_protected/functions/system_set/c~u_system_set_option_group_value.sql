...
BEGIN
    ...
    ON CONFLICT (system_set_id, option_group_system_option_value_path, option_name) DO UPDATE SET
        name = EXCLUDED.name
    WHERE ssogv.system_set_id = ss.id
    AND ssogv.option_group_system_option_value_path = ss.system_option_value_path
