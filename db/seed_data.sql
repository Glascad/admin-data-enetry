...
INSERT INTO detail_options (name, parent_system_detail_path, default_detail_option_value) VALUES ('STOPS', '1.SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD', 'UP');

INSERT INTO detail_option_values (name, parent_detail_option_path) VALUES
('UP', '1.SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.STOPS'),
('DOWN', '1.SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.STOPS');


INSERT INTO detail_options (name, parent_detail_option_value_path, default_detail_option_value) VALUES
('GLAZING', '1.SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.STOPS.DOWN', 'INSIDE');

INSERT INTO detail_option_values (name, parent_detail_option_path) VALUES
('INSIDE', '1.SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.STOPS.DOWN.GLAZING'),
('OUTSIDE', '1.SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.STOPS.DOWN.GLAZING');

INSERT INTO system_configurations (configuration_type, parent_detail_option_value_path) VALUES
('HEAD', '1.SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.STOPS.UP'),
('COMPENSATING_RECEPTOR', '1.SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.STOPS.UP'),
('HEAD', '1.SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.STOPS.DOWN.GLAZING.INSIDE'),
('COMPENSATING_RECEPTOR', '1.SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.STOPS.DOWN.GLAZING.INSIDE'),
('HEAD', '1.SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.STOPS.DOWN.GLAZING.OUTSIDE'),
('COMPENSATING_RECEPTOR', '1.SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.STOPS.DOWN.GLAZING.OUTSIDE');

INSERT INTO configuration_options (name, parent_system_configuration_path, default_configuration_option_value) VALUES
('DURABILITY', '1.SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.STOPS.DOWN.GLAZING.INSIDE.__CT__.COMPENSATING_RECEPTOR', 'STANDARD_DUTY'),
('DURABILITY', '1.SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.STOPS.DOWN.GLAZING.OUTSIDE.__CT__.COMPENSATING_RECEPTOR', 'STANDARD_DUTY'),
('DURABILITY', '1.SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.STOPS.UP.__CT__.COMPENSATING_RECEPTOR', 'STANDARD_DUTY');

INSERT INTO configuration_option_values (name, parent_configuration_option_path) VALUES
('STANDARD_DUTY', '1.SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.STOPS.DOWN.GLAZING.INSIDE.__CT__.COMPENSATING_RECEPTOR.DURABILITY'),
('HIGH_PERFORMANCE', '1.SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.STOPS.DOWN.GLAZING.INSIDE.__CT__.COMPENSATING_RECEPTOR.DURABILITY'),
('STANDARD_DUTY', '1.SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.STOPS.DOWN.GLAZING.OUTSIDE.__CT__.COMPENSATING_RECEPTOR.DURABILITY'),
('HIGH_PERFORMANCE', '1.SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.STOPS.DOWN.GLAZING.OUTSIDE.__CT__.COMPENSATING_RECEPTOR.DURABILITY'),
('STANDARD_DUTY', '1.SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.STOPS.UP.__CT__.COMPENSATING_RECEPTOR.DURABILITY'),
('HIGH_PERFORMANCE', '1.SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.STOPS.UP.__CT__.COMPENSATING_RECEPTOR.DURABILITY');
...
(1, '1.SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.STOPS.DOWN.GLAZING.OUTSIDE');

INSERT INTO system_set_configuration_option_values (system_set_id, configuration_option_value_path) VALUES
(1, '1.SET.CENTER.JOINERY.SCREW_SPLINE.__DT__.HEAD.STOPS.DOWN.GLAZING.OUTSIDE.__CT__.COMPENSATING_RECEPTOR.DURABILITY.STANDARD_DUTY');
