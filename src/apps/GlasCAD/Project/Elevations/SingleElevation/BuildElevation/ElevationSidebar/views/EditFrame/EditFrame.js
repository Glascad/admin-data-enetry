...
export const EditVertical = {
    title: "Edit Vertical",
    component: withSelectionContext(withActionContext(memo(props => <EditFrame {...props} vertical={true} />))),
};

export const EditHorizontal = {
    title: "Edit Horizontal",
    component: withSelectionContext(withActionContext(memo(props => <EditFrame {...props} vertical={false} />))),
};
