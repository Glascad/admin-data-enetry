...
import createSystemTypeDetailTypeConfigurationType from './configuration-types/create';
import updateSystemTypeDetailTypeConfigurationType from './configuration-types/update';
